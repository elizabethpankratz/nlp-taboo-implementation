...
\begin{columns}[t]
	...
	\begin{enumerate}
		...
		\begin{itemize}
			\item five words selected based on probability distribution from gold standard
		\end{itemize}
	\end{enumerate}
